                        ...
                        <div class="v-select">
                            <p @click="areSelectVisible = !areSelectVisible">
                                <img :src="info.country_flag" class="v-select__img" alt="">
                                    {{ info.name }}
                                <fa  v-bind:class=" { 'rotate-hover' :clickChange }"  class="menu-item-icon" icon="angle-down"/>
                            </p>
            ...
            <div class="header-wrapper_bottom " id="header-wrapper_bottom" >
                <div class="container">
                    <div class="header-wrapper_bottom1 " v-for="info in emailJSON" :key="info.id">
                        ...
                        <NavbarAdd class="nav__list" @scroll="stickyHeaderMenu()" id="nav__list"/>
...
import $ from 'jquery'
import NavbarAdd from './navbar-add.vue' 
